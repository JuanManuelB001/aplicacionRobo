            ...
            if (nombre.isEmpty() || telefono.isEmpty() || correo_electronico.isEmpty()) {
                ...
                if (!correo_electronico.isEmpty()) {
                    if (contrasena.equals(confirContrasena)) {
                        ...
                        Toast.makeText(RegistroUsuarioActivity.this, "Contraseña no Coincide", Toast.LENGTH_LONG).show();
                    }
                } else {
                    Toast.makeText(RegistroUsuarioActivity.this, "Por favor ingrese Correo Electrónico", Toast.LENGTH_LONG).show();
                }
            }
        }
    }
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            if (cont.length() < 6) {
                                Toast.makeText(RegistroUsuarioActivity.this, "Error: Ingrese una contraseña válida", Toast.LENGTH_LONG).show();
                                Toast.makeText(RegistroUsuarioActivity.this, "Mínimo 6 Caracteres.", Toast.LENGTH_LONG).show();
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(RegistroUsuarioActivity.this, "Ha ocurrido un error: " + e.getMessage(), Toast.LENGTH_LONG).show();
                        btnguardar.setEnabled(true);
            ...
            db.collection("Usuarios")
                    ...
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            ...
                            Intent intent = new Intent(RegistroUsuarioActivity.this, RegistroContactoActivity.class);
                            btnguardar.setEnabled(true);
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        @Override
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(RegistroUsuarioActivity.this, "Fallo al guardar", Toast.LENGTH_SHORT).show();
                            Log.e("RegistroUsuarioActivity", "Error al guardar usuario", e);
                            btnguardar.setEnabled(true);
                        }
                    });
